...
%\usepackage[backend=biber,style=authoryear]{biblatex}  % Opción backend=biber y el estilo deseado
...
%\cite{iwaniszewski2009astronomia}

\begin{frame}[allowframebreaks]{Bibliografía}
    
\begin{thebibliography}{20}

\bibitem{1} Turcotte, Donald L and Schubert, Gerald, \textit{Geodynamics}, Cambridge University Press, U.S.A., 2002.
      %\newblock 

\bibitem{2} Kramer, Steven Lawrence, \textit{Geotechnical earthquake engineering}, Pearson Education India, 1996.


\bibitem{3} Kearey, Philip and Klepeis, Keith A and Vine, Frederick J, \textit{Global tectonics}, John Wiley \& Sons, 2009.

\bibitem{4} Stein, Seth and Wysession, Michael, \textit{An introduction to seismology, earthquakes, and earth structure}, Cambridge University Press, U.S.A., 2002.
